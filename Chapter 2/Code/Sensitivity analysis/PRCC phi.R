...
for (i in 1:100){
  ...
  phi <- rbeta(n=1,shape1=191.18,shape2=577.26)
  lambda=0.04050593
  A <- 177.95295
  w <- 0.192
  G <- 62
...
write.csv(sens_phi, "~/PhD-work/Chapter 2/Data/Sensitivity analysis/sens_phi.csv")
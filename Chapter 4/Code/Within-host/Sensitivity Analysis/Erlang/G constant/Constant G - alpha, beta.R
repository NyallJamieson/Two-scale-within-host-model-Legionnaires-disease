...
for (i in 1:10){
  ...
  results <- dplyr::bind_rows(results,as.data.frame(na.omit(do.call(rbind,parallel::mclapply(1:10,MODEL.simul,mc.cores=2)),na.action="omit")))
}

write.csv(results, "SA_Erlang.Constant.ab.csv")
...
for (i in 1:1000){
  ...
  results <- dplyr::bind_rows(results,as.data.frame(na.omit(do.call(rbind,parallel::mclapply(1:1000,simulate_nMtau_R,mc.cores=64)),na.action="omit")))
}

write.csv(results, "SA_Burr.Intermediate.G.csv")